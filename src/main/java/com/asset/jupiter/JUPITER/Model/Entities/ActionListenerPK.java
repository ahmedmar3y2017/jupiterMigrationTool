...
/**
 * The primary key class for the MG_ACTION_LISTENER database table.
 * 
 */
@Embeddable
public class ActionListenerPK implements Serializable {
	...
	public ActionListenerPK() {
	}

	public ActionListenerPK(String path, long infoFileId) {
		this.path = path;
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ActionListenerPK)) {
			return false;
		}
		ActionListenerPK castOther = (ActionListenerPK)other;
		return 
